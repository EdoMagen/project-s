        ...
        <div class="wrapper">
            <div class="section one">
                <div class="content">
                    ...
                    <h2>We couldn't find what you were looking for, maybe try <br/><a href="/" onclick="ga('send', 'event', '404 page', 'click', 'homepage link');">Our homepage</a></h2>
                </div>
            </div>
