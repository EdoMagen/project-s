...
<head>
    ...
    <style>
    #loveme {
      background-color:#fff;background-image:url('../../img/accounts/funbox_bg1.jpg');background-size:contain;
    }
    #loveme_text {
      width: 95%;margin: 0.2em auto;padding: 15px; max-width: 1070px;
    }
    </style>
</head>
...
<div id="no_tag">
    ...
    <div id="no_tag_text">We're sorry, no such hashtag was found.<br/><a href="/accounts/funbox">Try
            again</a>
    </div>
</div>
<div id="loveme"><img src="../../img/accounts/funbox_logo.png" style="max-width:634px; background-size: cover;background-position: 50%;box-shadow: 5px 5px 15px #ddd;">
<div id="loveme_text">
