                    ...
                    <footer>
                        <ul class="footer-links-wrapper">
                            ...
                            <li class="footer-links">
                                <h3>Legal stuff</h3>
                                <ul class="links">
                                    <li class="link"><a href="/about-us.php" onclick="ga('send', 'event', 'Footer links', 'click', 'about us');">About us</a></li>
                                    <li class="link"><a href="/terms-of-use.php" onclick="ga('send', 'event', 'Footer links', 'click', 'terms of use');">Terms of use</a></li>
                                    <li class="link"><a href="/privacy-policy.php" onclick="ga('send', 'event', 'Footer links', 'click', 'privacy policy');">Privacy policy</a></li>
                                </ul>
                            </li>
                        </ul>
                    </footer>
